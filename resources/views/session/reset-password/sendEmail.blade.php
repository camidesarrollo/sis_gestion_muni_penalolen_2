            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                <div class="card card-plain mt-8">
                    ...
                    <div class="card-header pb-0 text-left bg-transparent">
                        <h4 class="mb-0">¿Ha olvidado su contraseña? Introduzca su correo electrónico aquí</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="/forgot-password" method="POST" role="form text-left">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0">Recuperar la contraseña</button>
                            </div>
                        </form>
                    </div>
                </div>
